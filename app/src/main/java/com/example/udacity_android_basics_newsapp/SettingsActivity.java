...
public class SettingsActivity  extends AppCompatActivity {
    ...
    public static class HealthPreferenceFragment extends PreferenceFragment
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            Preference minDate = findPreference(getString(R.string.settings_min_date_default));
            bindPreferenceSummaryToValue(minDate);

            Preference orderBy = findPreference(getString(R.string.settings_order_by_default));
